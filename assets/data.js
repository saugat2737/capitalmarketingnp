...
const categories = [
  ...
  { slug: "diaries", name: "Diaries", intro: "Corporate diaries crafted for institutions, banks, offices, and annual brand campaigns." },
  { slug: "notebooks", name: "Purse & Wallets", intro: "Premium Purse and wallet solutions with custom covers, inserts, packaging, and logo application." },
...
const sampleNames = ["Signature Edition", "Executive Series", "Classic Corporate", "Premium Matte", "Heritage Line", "Modern Utility"];
